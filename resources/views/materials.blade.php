        ...
        <div class="page-title-content">
            <div class="container">
                <div class="blog-title color-white">
                    <h2>{{ __('materials') }}</h2>
                    <span><a href="{{ route('home') }}" style="{{ App::isLocale('ar') ? 'direction: ltr;margin-left: 10px;' : '' }}" class="hv-color-st1 color-white"> {{ __('home') }} </a>{{ __('materials') }}</span>
                </div>
            </div>
        </div>
    </div><!-- Page-title -->
        ...
        <div class="container">
            <div class="row">
                <div class="what-we-do-style what-we-do-style2">
                    <div class="content-style2 clearfix {{ App::isLocale('ar') ? 'serice-test' : '' }}">
                        <div class="content-service-title">
                            <div class="title-section wow fadeInDown">
                                ...
                                <div class="flat-title">{{ __('materials-for-you') }}</div>
                            </div>
                        </div>
                        <div class="content-service">
                            <p class="content-p color-style1">
                                {!! App::isLocale('ar') ? app(App\Settings\SiteSetting::class)->material_page_text_ar : app(App\Settings\SiteSetting::class)->material_page_text_en !!}
                            </p>
                        </div>
                    </div>
                    ...
                    @foreach(\App\Models\Material::where('is_published', 1)->orderByDesc('id')->get() as $value => $service)
                        <div class="image-box"  style="{{ App::isLocale('ar') ? 'float: right;' : '' }}">
                            ...
                            <div class="title-imagebox" style="{{ App::isLocale('ar') ? 'direction: rtl;' : '' }}">
                                <h4>
                                    <a href="{{ route('materials-details', $service->id) }}">{{ App::isLocale('ar') ? $service->title_ar : $service->title_en }}</a>
                                </h4>
                            </div>
