        ...
        <div class="page-title-content">
            <div class="container">
                <div class="blog-title color-white">
                    <h2>{{ App::isLocale('ar') ? $service->title_ar : $service->title_en }}</h2>
                    <span><a href="{{ route('home') }}" style="{{ App::isLocale('ar') ? 'direction: ltr;margin-left: 10px;' : '' }}" class="hv-color-st1 color-white"> {{ __('home') }} </a>{{ App::isLocale('ar') ? $service->title_ar : $service->title_en }}</span>
                </div>
            </div>
        </div>
    </div><!-- Page-title -->
                    ...
                    <div id="sidebar sidebar-service">
                        <div id="inner-sidebar" class="inner-content-wrap">
                            ...
                            <div class="widget widget-style2 widget-category widget-bg">
                                <h2 class="widget-title-style2 widget-title-style2 "><span>{{ __('popular-service') }}</span></h2>
                                <ul class="category-wrap wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                    @foreach(\App\Models\Services::where('is_published', 1)->whereNot('id', $service->id)->limit(5)->orderByDesc('id')->get() as $popService)
                                        <li>
                                            <div class="block-inside">
                                                <a href="{{ route('services-details', $popService->id) }}">{{ App::isLocale('ar') ? $popService->title_ar : $popService->title_en }}</a>
                                            </div>
                                        </li>
                                    @endforeach
                                </ul>
                    ...
                    <div class="site-content-style2">
                        <div class="image-hover ">
                            <div class="image border-5">
                                <img loading="lazy" style="width: 100% !important;" src="{{ URL::asset('storage/' . $service->image) }}" alt="images">
                            </div>
                        </div>
                        <div class="title-section wow fadeInDown"  style="{{ App::isLocale('ar') ? 'direction: rtl;' : '' }}">
                            <div class="flat-title">
                                {{ App::isLocale('ar') ? $service->title_ar : $service->title_en }}
                            </div>
                        </div>
                    </div>
