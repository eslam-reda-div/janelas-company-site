...
<head>
    ...
    <title>{{ app(App\Settings\SiteSetting::class)->title }} - Blog</title>
        ...
        <div class="page-title-content">
            <div class="container">
                <div class="blog-title color-white">
                    <h2>{{ App::isLocale('ar') ? $post->title_ar : $post->title_en }}</h2>
                    <span><a href="{{ route('home') }}" style="{{ App::isLocale('ar') ? 'direction: ltr;margin-left: 10px;' : '' }}" class="hv-color-st1 color-white"> {{ __('home') }} </a>{{ App::isLocale('ar') ? Str()->limit($post->title_ar, 25) : Str()->limit($post->title_en, 25) }}</span>
                </div>
            </div>
        </div>
    </div><!-- Page-title -->
            ...
            <div class="col-left">
                <div class="site-content site-content-style boder-bottom">
                    <article class="main-post main-post-style2">
                        ...
                        <div class="content-post flat-row1" style="{{ App::isLocale('ar') ? 'direction: rtl;' : '' }}">
                            <ul class="post-meta">
                                <li class="font-date">
                                    <span>
                                ...
                                <li class="font-date"><span><span><i class="far fa-calendar-alt"></i>{{ \Illuminate\Support\Carbon::make($post->created_at)->format('j F Y') }}</span></span></li>
                            </ul>
                        </div>
                        <div class="title-post"  style="{{ App::isLocale('ar') ? 'direction: rtl;margin-right: 20px' : '' }}">
                            <h3><span>{{ App::isLocale('ar') ? $post->title_ar : $post->title_en }}</span></h3>
                        </div>
                    </article>
                    <!-- main-post -->
                    <article class="main-post main-post-style1">
                        {!! App::isLocale('ar') ? $post->content_ar : $post->content_en !!}
                    </article>
                    <!-- main-post -->
                </div>
...
<!-- Mirrored from themesflat.co/html/janelas/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 15:04:35 GMT -->
</html>
