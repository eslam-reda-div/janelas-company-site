...
<!-- Mirrored from themesflat.co/html/janelas/page-case-study.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 15:04:23 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="page-title-content">
            <div class="container">
                <div class="blog-title color-white">
                    <h2>{{ __('case-study') }}</h2>
                    <span><a href="{{ route('home') }}" style="{{ App::isLocale('ar') ? 'direction: ltr;margin-left: 10px;' : '' }}" class="hv-color-st1 color-white"> {{ __('home') }} </a>{{ __('case-study') }}</span>
                </div>
            </div>
        </div>
    </div><!-- Page-title -->
        ...
        <div class="container portfolio-style">
            <div class="tf-tabs-style">
                <div class="flat-tabs tabs-case flat-tabs-type2 clearfix">
                    <ul class="menu-tab">
                        @if(\App\Models\CaseCategory::count() > 0)
                            <li class="active">
                                <a href="#">{{ __('all') }}</a>
                            </li>
                            @foreach(\App\Models\CaseCategory::all() as $CaseSec)
                                <li>
                                    <a href="#">
                                        {{ App::isLocale('ar') ? $CaseSec['name_ar'] : $CaseSec['name_en'] }}
                                    </a>
                                </li>
                            @endforeach
                        @endif
                    ...
                    <div class="content-tab">
                                    ...
                                    @foreach(\App\Models\CaseStudy::where('is_published', 1)->get() as $caseStudy)
                                        @if($caseStudy->is_published)
                                            <div class="image-profolio image-profolio-style2 style2">
                                                <div class="image">
                                                    <img loading="lazy"
                                                        src="{{ URL::asset('storage/' . $caseStudy->image) }}"
                                                        alt="images"
                                                    />
                                                </div>
                                                <div class="profolio-show">
                                                    <div class="content-title text-left tf-text-hv">
                                                        ...
                                                        <a href="{{ route('case-study-details', $caseStudy->id) }}" class="tftitle-style2">
                                                            {!! App::isLocale('ar') ? $caseStudy->small_description_ar : $caseStudy->small_description_en !!}
                                                        </a>
                                                    </div>
                                                    <div class="btn-tab">
                        ...
                        @foreach(\App\Models\CaseCategory::with('CaseStudy')->get() as $caseCat)
                            <div class="content-inner">
                                <div class="col-tab align-items-center">
                                    <div class="tabs-case-study">
                                        @foreach($caseCat->CaseStudy as $caseStudy)
                                            @if($caseStudy->is_published)
                                                <div class="image-profolio image-profolio-style2 style2">
                                                    <div class="image">
                                                        <img loading="lazy"
...
<!-- Mirrored from themesflat.co/html/janelas/page-case-study.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 15:04:25 GMT -->
</html>
