...
<!-- Mirrored from themesflat.co/html/janelas/study-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 15:04:25 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>{{ app(App\Settings\SiteSetting::class)->title }} - Case Studies</title>
...
<div class="animsition boxed blog">
        ...
        <div class="page-title-content">
            <div class="container">
                <div class="blog-title color-white">
                    <h2>{{ App::isLocale('ar') ? $caseStudy->title_ar : $caseStudy->title_en }}</h2>
                    <span><a href="{{ route('home') }}" style="{{ App::isLocale('ar') ? 'direction: ltr;margin-left: 10px;' : '' }}" class="hv-color-st1 color-white"> {{ __('home') }} </a>{{ App::isLocale('ar') ? $caseStudy->title_ar : $caseStudy->title_en }}</span>
                </div>
            </div>
        </div>
    </div><!-- Page-title -->
            ...
            <div class="meta-post">
                <div class="image-hover">
                    <div class="image boder-style">
                        <img style="width: 100% !important;" loading="lazy" src="{{ URL::asset('storage/' . $caseStudy->image) }}" alt="">
                    </div>
                </div>
                <div style="{{ App::isLocale('ar') ? 'text-align: end;' : '' }}" class="content-post wow fadeInRight animated" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <div class="tf-post">
                        <div class="tftitle-style4">
                            {{ __('title') }}
                        </div>
                        <p style="{{ App::isLocale('ar') ? 'padding-right: 0px;' : '' }}">
                            {{ App::isLocale('ar') ? $caseStudy->title_ar : $caseStudy->title_en }}
                        </p>
                    </div>
                    ...
                    <div class="tf-post">
                        ...
                        <p style="{{ App::isLocale('ar') ? 'padding-right: 0px;' : '' }}">
                            @foreach($caseStudy->CaseCategory as $category)
                    ...
                    <div class="tf-post">
                        ...
                        <p style="{{ App::isLocale('ar') ? 'padding-right: 0px;' : '' }}">
                            {{ \Illuminate\Support\Carbon::make($caseStudy->date)->format('j F Y') }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="info-project">
        <div class="container">
            {!! App::isLocale('ar') ? $caseStudy->description_ar : $caseStudy->description_en !!}
        </div>
            ...
            <div class="portfolio-nav bg-white clearfix" >
                <div class="title-nav title-nav-style flex">
                    <div class="title-section wow fadeInDown">
                        <div class="flat-title color-style1">{{ __('related-projects') }}</div>
                    </div>
                </div>
            </div>
            <div class="tf-partners tf-partners-style image-profolio-hv partners-style2">
                <div class="banners-z">
                    <div class="flat-carousel-box data-effect clearfix"
                         data-zero="0"
                         data-gap="30"
                         data-column="3"
                         data-column2="2"
                            ...
                            @foreach($related as $relatedCase)
                                <div class="tabs-case-study">
                                    <div class="image-profolio style2">
                                        <div class="image boder-style">
                                            <img loading="lazy"
                                                src="{{ URL::asset('storage/' . $relatedCase->image) }}"
                                                alt="images"
                                            />
                                        </div>
                                        <div class="profolio-show active">
                                            <div class="content-title text-left tf-text-hv">
                                                <h4>
                                                    {{ App::isLocale('ar') ? $relatedCase->title_ar : $relatedCase->title_en }}
                                                </h4>
                                                <a href="{{ route('case-study-details', $relatedCase->id) }}" class="tftitle-style2">
                                                    {!! App::isLocale('ar') ? $relatedCase->small_description_ar : $relatedCase->small_description_en !!}
                                                </a>
                                            </div>
                                            <div class="btn-tab">
                                                <a href="{{ route('case-study-details', $relatedCase->id) }}"><i class="fas fa-arrow-right"></i
                                                    ></a>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Mirrored from themesflat.co/html/janelas/study-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 15:04:26 GMT -->
</html>
