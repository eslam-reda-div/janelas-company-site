...
<div class="animsition boxed blog">
        ...
        <div class="page-title-content">
            <div class="container">
                <div class="blog-title color-white">
                    <h2>{{ __('blog') }}</h2>
                    <span><a href="{{ route('home') }}" style="{{ App::isLocale('ar') ? 'direction: ltr;margin-left: 10px;' : '' }}" class="hv-color-st1 color-white"> {{ __('home') }} </a>{{ __('blog') }}</span>
                </div>
            </div>
        </div>
    </div><!-- Page-title -->
    ...
    <footer id="footer" class="footer" style="{{ App::isLocale('ar') ? 'direction: rtl;' : '' }}background-image: url('{{ URL::asset('storage/' . app(App\Settings\SiteSetting::class)->footer_image) }}');margin-top: 50px">
...
<!-- Mirrored from themesflat.co/html/janelas/blog-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 15:04:33 GMT -->
</html>
