...
class CaseCategoryPolicy
{
    ...
    {
        return $user->can('view_any_case::category');
    }
    ...
    {
        return $user->can('view_case::category');
    }
    ...
    {
        return $user->can('create_case::category');
    }
    ...
    {
        return $user->can('update_case::category');
    }
    ...
    {
        return $user->can('delete_case::category');
    }
    ...
    {
        return $user->can('delete_any_case::category');
    }
     ...
     */
    public function replicate(User $user, CaseCategory $caseCategory): bool
    {
