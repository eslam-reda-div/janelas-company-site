...
class ContactMessagesPolicy
{
    ...
    {
        return $user->can('view_any_contact::messages');
    }
    ...
    {
        return $user->can('view_contact::messages');
    }
    ...
    {
        return $user->can('create_contact::messages');
    }
    ...
    {
        return $user->can('update_contact::messages');
    }
    ...
    {
        return $user->can('delete_contact::messages');
    }
    ...
    {
        return $user->can('delete_any_contact::messages');
    }
     ...
     */
    public function replicate(User $user, ContactMessages $contactMessages): bool
    {
