...
class SubscribersPolicy
{
    ...
    {
        return $user->can('view_any_subscribers');
    }
    ...
    {
        return $user->can('view_subscribers');
    }
    ...
    {
        return $user->can('create_subscribers');
    }
    ...
    {
        return $user->can('update_subscribers');
    }
    ...
    {
        return $user->can('delete_subscribers');
    }
    ...
    {
        return $user->can('delete_any_subscribers');
    }
     ...
     */
    public function replicate(User $user, Subscribers $subscribers): bool
    {
